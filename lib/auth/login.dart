      ...
      body: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text("Foodky",  style: TextStyle(
                      fontSize: 50.0, color:Colors.orange.shade900, fontWeight: FontWeight.w900,fontFamily: "Montserrat",)
                    ),
             ...
             /*async{
              ...
              Center(
                ...
                child: RaisedButton(
                  ...
                  hoverColor: Colors.white,
                  color: Colors.orangeAccent,
                  child: Text("Corporate Application",
                  style: TextStyle(color: Colors.white,fontFamily:"Montserrat",fontWeight: FontWeight.bold),),
                  onPressed: (){
